    ...
    },
    {
      ...
      "options": {
        ...
        "tutorial": [
          ...
          "빨강색 블럭은 맞을 때마다 도파민 수치를 1 상승시키고, 초록색 블럭은 1 감소시켜!",
          "블록에 적힌 숫자는 남은 내구도야.",
    ...
    },
    {
      ...
      "options": {
        ...
        "tutorial": [
          ...
          "적을 처치하면 도파민이 올라. 빨간 표시는 도파민 상승이라고 보면 돼.",
          "이제 별도 기술은 없어. 계속 움직이면서 쏘고, 적탄과 적 몸통을 피해.",
          "적을 처치하면 캡슐이 나올 수 있어. 빨간 캡슐은 도파민 +8, 초록 캡슐은 도파민 -10이야.",
          "더블샷 캡슐을 먹으면 발사체가 2개가 되고, 한 번 먹으면 다시 나오지 않아.",
          "도파민은 자연스럽게 빠르게 감소하니까 적을 꾸준히 처치해야 해.",
          "처치가 끊기거나 적에게 맞으면 수치가 금방 줄어."
        ]
      },
      "id": 56
    }
